    ...
    try {
      ...
      const data: Record<string, any> = {
        ...
        discountValue:
          formData.discountType === "fixed"
            ? Math.round(discountValue * 100) // Convert pounds to pence
            : discountValue,
      ...
      if (formData.minPurchase) {
        ...
        if (!isNaN(minPurchase) && minPurchase > 0) {
          data.minPurchase = Math.round(minPurchase * 100); // Convert to pence
        }
      }
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-semibold text-neutral-900">Create Coupon</h1>
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
        ...
        <AdminCard hover={false}>
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500 mt-1">
                Cart must be at least this amount to use the coupon
              </p>
            </div>
        ...
        <div className="flex gap-3">
          <Button type="submit" disabled={loading} className="bg-black hover:bg-neutral-800">
            {loading ? (
              <>
